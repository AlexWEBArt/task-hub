...
import { dailyStats, monthlyStats, yearlyStats } from '../data/project-chart-points.data'
...
const ProjectStatsChart = () => {
    ...
    return (
        <div className="flex flex-col justify-between bg-white dark:bg-neutral-800 rounded-2xl mb-4 w-full max-w-xl font-[Poppins]">
            <div className="flex justify-between items-center p-6 mb-4">
                <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Projects Statistic</h2>
                <div className="flex rounded-full border-[#ECECEC] border-2 pr-3">
                    <select
                        value={period}
                        onChange={(e) => setPeriod(e.target.value as IChartPeriod)}
                        className=" text-black text-sm pl-4 py-1.5 focus:outline-none dark:text-gray-100"
                    >
